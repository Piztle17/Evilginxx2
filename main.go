...
func showAd() {
	...
	message := fmt.Sprintf("%s: %s %s", lred.Sprint("Evilginx Mastery Course"), lblue.Sprint("https://academy.breakdev.org/evilginx-mastery"), white.Sprint("(learn how to create phishlets)"))
	// message in big font " Educational purpuse only "
	log.Info("====================================================")
	log.Info("=                                                  =")
	log.Info("=  %s  =", lred.Sprint("Educational purpose only"))
	log.Info("=                                                  =")
	log.Info("====================================================")
	log.Info("%s", message)
	log.Info("%s %s", lred.Sprint("If u got any questions then"), lblue.Sprint("https://fluxxset.com/"))
}
