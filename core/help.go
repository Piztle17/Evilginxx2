...
func NewHelp() (*Help, error) {
	...
	h.AddCommand(
		"set_turnstilekey",
		"custom",
		"set_turnstilekey <key>",
		"Set the custom Turnstile key for bot protection.",
    	1,
        readline.NewPrefixCompleter(
            readline.PcItem("set_turnstilekey"),
        ),
    )
    ...
    h.AddCommand(
        ...
        "custom",
        "set_cache <on|off>",
        "Enable or disable custom cache (on/off).",
        1,
        readline.NewPrefixCompleter(
            readline.PcItem("set_cache"),
        ),
    )
    ...
    h.AddCommand(
        "set_customssl",
        "custom",
        "set_customssl <on|off>",
        "Enable or disable custom SSL (on/off).",
        1,
        readline.NewPrefixCompleter(
            readline.PcItem("set_customssl"),
        ),
    )
